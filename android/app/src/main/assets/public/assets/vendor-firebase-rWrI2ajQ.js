 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const U_="storage";function KS(n=iu(),e){n=G(n);const r=Xr(n,U_).getImmediate({identifier:e}),s=Ff("storage");return s&&uS(r,...s),r}function uS(n,e,t,r={}){aS(n,e,t,r)}function lS(n,{instanceIdentifier:e}){const t=n.getProvider("app").getImmediate(),r=n.getProvider("auth-internal"),s=n.getProvider("app-check-internal");return new cS(t,r,s,e,nr)}function hS(){zn(new ln(U_,lS,"PUBLIC").setMultipleInstances(!0)),gt(kf,Df,""),gt(kf,Df,"esm2020")}hS();export{wS as $,bS as A,IS as B,SP as C,$b as D,kS as E,_S as F,Jt as G,gS as H,NS as I,vS as J,qS as K,TS as L,rr as M,Qt as N,ho as O,Yt as P,MS as Q,xS as R,Xt as S,ne as T,lE as U,DS as V,AS as W,mS as X,ES as Y,VS as Z,pS as _,pb as a,OS as a0,fS as a1,PS as a2,SS as a3,ME as a4,RS as a5,US as a6,BS as a7,FS as a8,sT as a9,Vt as aa,CS as ab,Bh as ac,CT as ad,Pp as ae,_T as af,GS as ag,KS as b,IP as c,d_ as d,uP as e,qb as f,$S as g,lb as h,FI as i,_P as j,bP as k,EP as l,CP as m,vP as n,nu as o,oP as p,Lb as q,RP as r,Cb as s,Db as t,AP as u,du as v,Fb as w,LS as x,dS as y,yS as z};
