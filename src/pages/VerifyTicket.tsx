          ...
          <div className="p-8 sm:p-12 space-y-10">
            ...
            {isStaff ? (
              ...
              <div className="mt-10 pt-10 border-t border-stone-800 text-center">
                <p className="text-stone-500 font-black uppercase text-[10px] tracking-widest">
                  Order Ownership Verified: {order.customerName}
                </p>
                <p className="text-[9px] text-stone-600 mt-2 max-w-[200px] mx-auto leading-relaxed">
